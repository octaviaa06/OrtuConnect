...
if ($result && isset($result['success']) && $result['success'] === true) {
    ...
    if ($_SESSION['role'] === 'admin') {
        $redirect_url = "../dashboard_admin/home_admin.php";
    } else if ($_SESSION['role'] === 'guru') {
        $redirect_url = "../dashboard_guru/dashboardGuru.php";
    } else {
    ...
    if (file_exists($redirect_url)) {
        ...
        // Fallback: redirect ke halaman default dengan parameter
        header("Location: index.php?error=Halaman tidak ditemukan: " . $redirect_url);
    }
    exit;
