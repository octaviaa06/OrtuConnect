...
session_start();
// $_SESSION['last_page'] = 'data_siswa.php'; // Baris ini tidak diperlukan dan dihapus
...
// API yang digunakan adalah API Admin sesuai kode asli
...
if (curl_errno($ch)) {
    //echo "cURL Error: " . curl_error($ch); // Komentar jika Anda tidak ingin menampilkan error mentah
...
// Tambahkan parameter 'from' ke URL untuk digunakan di profil.php
// Nilai 'from' harus disamakan dengan CASE di konfirmasi_logout.php
    ...
    <div class="flex-grow-1 main-content"
        ...
        <div class="container-fluid py-3">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 header-fixed">
                ...
                <?php 
                // Kita buat Query String agar profil.php tahu halaman asalnya.
...
<script>
// Logika Profile dropdown dihapus karena sudah ditangani oleh ../profil/profil.php
